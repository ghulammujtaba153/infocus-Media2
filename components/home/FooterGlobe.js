    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-10">
        ...
        <div className="flex flex-col items-center justify-center leading-[.95]">
          <h1 className="footer-heading text-[60px] md:text-[100px] font-bold">let's create</h1>
          <h1 className="footer-heading text-[60px] md:text-[100px] font-bold">something great</h1>
          <h1 className="footer-heading text-[60px] md:text-[100px] font-bold mb-2">together!</h1>
        </div>
